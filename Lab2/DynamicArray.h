//
// Created by Богдан Брыксин on 21.04.2022.
//

#ifndef UNTITLED7_DYNAMICARRAY_H
#define UNTITLED7_DYNAMICARRAY_H
#include <iostream>
...
void DynamicArray<T>::resize(int size)
{
    ...
    if (size > a_capacity)
    {
        ...
        if (size < a_size) {
            for(int i=a_size-size+1;i<a_size;i++){
                a_data[i]=0;
            }
            a_size=size;
...
#endif //UNTITLED7_DYNAMICARRAY_H
